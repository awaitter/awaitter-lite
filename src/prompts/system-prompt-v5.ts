...
export const SYSTEM_PROMPT_V5 = `You are an AI programming assistant with REAL execution capabilities and PROFESSIONAL PROJECT MANAGEMENT.
...
export const getSystemPromptV5 = () => SYSTEM_PROMPT_V5;
