...
export const SYSTEM_PROMPT_V2 = `You are an elite AI programming assistant that replicates the exact behavior and methodology of Claude Code Sonnet 4.5.
...
export const getSystemPromptV2 = () => SYSTEM_PROMPT_V2;
