...
class RoadmapParser {
     ...
     */
    static parseRoadmap(text, originalRequest) {
     ...
     */
    static parseTasks(sprintText, sprintId) {
        const tasks = [];
     ...
     * Detect project type from text
     */
    static detectProjectType(text, originalRequest) {
     ...
     */
    static updateRoadmapFromText(roadmap, text) {
        let updatedCount = 0;
     ...
     */
    static updateTaskStatus(roadmap, sprintId, taskId, statusEmoji) {
        let status;
        if (statusEmoji === '✅') {
            status = 'completed';
        }
...
//# sourceMappingURL=RoadmapParser.js.map