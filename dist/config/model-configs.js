...
exports.REASONING_MODES = exports.MODEL_CONFIGS = void 0;
exports.getModelConfig = getModelConfig;
exports.getTaskOptimizedConfig = getTaskOptimizedConfig;
...
function getModelConfig(modelName) {
    ...
    if (exports.MODEL_CONFIGS[modelName]) {
        return exports.MODEL_CONFIGS[modelName];
    }
    // Try partial match
    for (const [key, config] of Object.entries(exports.MODEL_CONFIGS)) {
 ...
 */
function getTaskOptimizedConfig(baseConfig, taskType) {
    switch (taskType) {
        case 'debug':
